-- CLEANUP SQL: Duplicate Service Removal & Migration v2
BEGIN;
...
-- ==========================================
-- VALIDATION: Confirm all 23 duplicates are gone
-- ==========================================
DO $$
DECLARE
  remaining_dups INT;
BEGIN
  ...
  FROM services 
  WHERE id IN (
    'ff3379a6-5c8c-4daf-b2fc-b32e9c74b188',
    'bd4fc599-2bc5-4ac7-969a-ba893c5b00dd',
    '086a15d1-c92d-4c57-b95e-7a0b4007293c',
    'c52aa79f-03d9-475c-9511-c6a2660b53e7',
    '49064e05-b819-4ecc-97c3-8b43813717e9',
    '0bbdaa0b-ae69-4c0f-9c6d-0f228be53a3a',
    '178e13a8-9b68-4ab3-badc-7ae820313fd1',
    'b91265c3-e555-43a9-bc60-43fe4b5128a8',
    'ec45f1b0-e2f0-44f2-b096-76667d6d4661',
    '0f7ca0a8-982c-4d54-a32b-0166b0b737c6',
    '3274c1d6-77e6-4df7-aefa-5443aeffee1f',
    'dce8d339-3d69-4782-9e6f-6113cd7f217d',
    '10000000-0000-0000-0000-000000000034',
    '2384954f-4d3c-496e-a963-801c7118c33d',
    '10000000-0000-0000-0000-000000000056',
    '5886d74f-acb0-49bc-b666-35d6c53ad486',
    '6ebfc334-9d58-44c6-94fe-be99fbe4a55a',
    'ca86b241-767b-43d3-9981-199f9d62e09e',
    '632f1956-cde3-40ad-9719-14fee45e5fd3',
