...
export const professionals: Professional[] = [
  ...
  { id: '00000000-0000-0000-0000-000000000002', name: 'Dhiani Sbrussi', role: 'Corporal / Estética / Injetáveis', avatar: 'DS' },
...
export const services: Service[] = [
  // Bruna Castanheira
  { id: 'srv1', name: 'Aplicação de Botox', duration: 90, ...parsePrice('encaminhar dr bruna'), professionalIds: ['5', '2'], category: 'Injetáveis' },
  ...
  { id: 'srv4', name: 'Bioestimulador com Elleva', duration: 60, ...parsePrice('encaminhar dr bruna'), professionalIds: ['5', '2'], category: 'Injetáveis' },
  { id: 'srv5', name: 'Bioestimulador com Harmonyca', duration: 60, ...parsePrice('encaminhar dr bruna'), professionalIds: ['5', '2'], category: 'Injetáveis' },
  { id: 'srv6', name: 'Bioestimulador com Radiesse', duration: 60, ...parsePrice('encaminhar dr bruna'), professionalIds: ['5', '2'], category: 'Injetáveis' },
  { id: 'srv7', name: 'Bioestimulador com Sculptra', duration: 60, ...parsePrice('encaminhar dr bruna'), professionalIds: ['5', '2'], category: 'Injetáveis' },
  { id: 'srv8', name: 'Bioestimulador de Gluteo', duration: 60, ...parsePrice('encaminhar dr bruna'), professionalIds: ['5', '2'], category: 'Injetáveis' },
  { id: 'srv9', name: 'Harmonização Facial', duration: 120, ...parsePrice('encaminhar dr bruna'), professionalIds: ['5', '2'], category: 'Injetáveis' },
  { id: 'srv10', name: 'Lavieen', duration: 60, ...parsePrice('encaminhar dr bruna'), professionalIds: ['5'], category: 'Facial' },
  { id: 'srv11', name: 'Lipo de Papada', duration: 30, ...parsePrice('encaminhar dr bruna'), professionalIds: ['5', '2'], category: 'Injetáveis' },
  ...
  { id: 'srv15', name: 'Preenchedor de Glúteo', duration: 60, ...parsePrice('encaminhar dr bruna'), professionalIds: ['5', '2'], category: 'Injetáveis' },
  { id: 'srv16', name: 'Preenchimento Bigodinho Chinês', duration: 60, ...parsePrice('encaminhar dr bruna'), professionalIds: ['5', '2'], category: 'Injetáveis' },
  { id: 'srv17', name: 'Preenchimento de Mandíbula', duration: 60, ...parsePrice('encaminhar dr bruna'), professionalIds: ['5', '2'], category: 'Injetáveis' },
  { id: 'srv18', name: 'Preenchimento de Mento', duration: 60, ...parsePrice('encaminhar dr bruna'), professionalIds: ['5', '2'], category: 'Injetáveis' },
  { id: 'srv19', name: 'Preenchimento de Olheiras', duration: 60, ...parsePrice('encaminhar dr bruna'), professionalIds: ['5', '2'], category: 'Injetáveis' },
  { id: 'srv20', name: 'Preenchimento de Têmporas', duration: 60, ...parsePrice('encaminhar dr bruna'), professionalIds: ['5', '2'], category: 'Injetáveis' },
  { id: 'srv21', name: 'Preenchimento de Zigomático', duration: 60, ...parsePrice('encaminhar dr bruna'), professionalIds: ['5', '2'], category: 'Injetáveis' },
  { id: 'srv22', name: 'Preenchimento Labial', duration: 60, ...parsePrice('encaminhar dr bruna'), professionalIds: ['5', '2'], category: 'Injetáveis' },
  { id: 'srv23', name: 'Preenchimento Linha Marionete', duration: 60, ...parsePrice('encaminhar dr bruna'), professionalIds: ['5', '2'], category: 'Injetáveis' },
  { id: 'srv24', name: 'Preenchimento Malar', duration: 60, ...parsePrice('encaminhar dr bruna'), professionalIds: ['5', '2'], category: 'Injetáveis' },
  { id: 'srv25', name: 'Rinomodelação', duration: 90, ...parsePrice('encaminhar dr bruna'), professionalIds: ['5', '2'], category: 'Injetáveis' },
  { id: 'srv26', name: 'Skinbooster', duration: 45, ...parsePrice('encaminhar dr bruna'), professionalIds: ['5', '2'], category: 'Injetáveis' },
  ...
  { id: 'srv83', name: 'Injetáveis', duration: 30, ...parsePrice('consulta avaliação'), professionalIds: ['6', '2'], category: 'Injetáveis' },
  { id: 'srv84', name: 'Soroterapia', duration: 45, ...parsePrice('consulta avaliação'), professionalIds: ['6', '2'], category: 'Injetáveis' },
